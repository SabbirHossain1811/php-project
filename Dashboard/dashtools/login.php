                    ...
                    <div class="alert-content">
                        <span class="alert-title">
                            ...
                            <span class="alert-text">
                                Mr. <?php echo $_SESSION['register_name'] ?>
                            </span>
                        </span>
                    </div>
                </div>
