...
<div class="app-sidebar">
            <div class="logo">
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        <img src="../../public/backend/assets/images/Photoroom-20240821_004044.png">
                        <span class="activity-indicator"> </span>
                        <span class="user-info-text"><?= $_SESSION['author_name'] ?> <br></span></span>
                        <span class="user-info-text"><?= $_SESSION['author_email'] ?> <br></span></span>
                    </a>
                </div>
            </div>
            <div class="app-menu">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-flex">
                            ...
                            <li class="nav-item hidden-on-mobile">
                                    <a style="font-size:14px; font:bold; display:flex; gap:11px; width:91px; color:white; background-color:indigo; border-radius:10px" class="nav-link btn " href="../logout/logout.php">LogOut <i style="margin-top: 2px;" class="fa-solid fa-person-walking-luggage"></i></a>
