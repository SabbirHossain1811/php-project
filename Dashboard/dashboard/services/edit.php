    ...
    <div class="col-10">
        <div class="card">
            <div class="card-header">
                <h4 style="font-weight: bold;">Service Edit...!!</h4>
            </div>
            ...
            <div class="card-body">
                <form action="store.php?update=<?= $service['id'] ?>" method="POST">
                    ...
                    <input style="font-size: 15px;" type="text" name="title" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $service['title'] ?>">

                    <label style="font-weight: bold; " for="exampleInputEmail1" class="form-label my-2">Service description</label>
                    <textarea style="font-size: 15px;" type="text" name="description" class="form-control" rows-5><?= $service['description'] ?></textarea>

                    <label style="font-weight: bold; " for="exampleInputEmail1" class="form-label my-2">Icon</label>
                    <input style="font-size: 15px;" type="text " readonly name="icon" class="form-control" id="icon" aria-describedby="emailHelp" value="<?= $service['icon'] ?>">
